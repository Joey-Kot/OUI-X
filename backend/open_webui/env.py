...
TOOL_CALL_MAX_CONCURRENCY = os.environ.get("TOOL_CALL_MAX_CONCURRENCY", "8")

if TOOL_CALL_MAX_CONCURRENCY == "":
    TOOL_CALL_MAX_CONCURRENCY = 8
else:
    try:
        TOOL_CALL_MAX_CONCURRENCY = max(1, int(TOOL_CALL_MAX_CONCURRENCY))
    except Exception:
        TOOL_CALL_MAX_CONCURRENCY = 8
